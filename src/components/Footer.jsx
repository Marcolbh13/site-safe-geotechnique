      ...
      <div className="relative z-10 container-safe grid gap-[clamp(1.75rem,4vw,2.75rem)] pb-11 grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1.2fr]">
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <div className="mt-6 flex items-center gap-3">
            <a href={COMPANY.social.linkedin} target="_blank" rel="noopener noreferrer" aria-label="Groupe RESUM sur LinkedIn"
              className="grid place-items-center w-10 h-10 rounded-full border border-white/20 text-[#d3c7d6] hover:text-white hover:border-white/55 transition-colors">
            ...
            <a href={COMPANY.social.instagram} target="_blank" rel="noopener noreferrer" aria-label="SAFE Géotechnique sur Instagram"
              className="grid place-items-center w-10 h-10 rounded-full border border-white/20 text-[#d3c7d6] hover:text-white hover:border-white/55 transition-colors">
              <svg viewBox="0 0 24 24" className="w-[18px] h-[18px]" fill="currentColor" aria-hidden="true">
